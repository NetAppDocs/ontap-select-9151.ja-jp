...
* FlexCache
+
ONTAP Select での FlexCache 書き戻しのサポートには制限があります。詳細については、link:https://docs.netapp.com/us-en/ontap-select/concept_ots_overview.html#flexcache-write-back-with-ontap-select["FlexCache による ONTAP Select への書き戻し"^]を参照してください。
