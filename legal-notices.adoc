...
NOTICEファイルには、NetAppソフトウェアで使用されているサードパーティの著作権およびライセンスに関する情報が記載されています。

* link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3318067["ONTAP Select 9.15.1に関する注意事項"^]
